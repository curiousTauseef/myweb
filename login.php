...
<form id="login">
  ...
  <div class="group">
    <input type="password" name="passowrd" id="password"><span class="highlight"></span><span class="bar"></span>
    <label>Password</label>
  </div>
  <button type="button" class="button buttonBlue" onclick="LoginFunction()" >Login
